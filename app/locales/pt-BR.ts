export default {
  ...
  description: "Engenheiro de software com expertise em React, Node.js e Go.",
  hire: "Me contrate",
  ...
  skills: {
    ...
    blockchain:
      "Habilidade na construção de blockchains descentralizadas, criando, gerenciando e otimizando redes seguras e transparentes sem a necessidade de intermediários.",
    solidity:
      "Habilidade no desenvolvimento, teste e implantação de contratos inteligentes no Ethereum e em outras plataformas de blockchain.",
  },
  expertise: {

export default {
  ...
  featured: {
    ...
    description:
      "Check out some of my latest projects showcasing my skills in React, Node.js, and Go.",
  },
  exp: {
  ...
  skills: {
    ...
    blockchain:
      "Skilled in building decentralized blockchains creating, managing, and optimizing secure and transparent networks without the need for intermediaries.",
    solidity:
      "Skilled in developing, testing, and deploying smart contracts on Ethereum and other blockchain platforms.",
  },
  expertise: {
    title: "My Expertise",
